...
const apiKindInfo: Record<Exclude<Kind, DeviceProviderKind | 'crewly-gateway'>, { title: string; about: string; needs: string }> = {
...
export function ProviderConnect({ onConnected, onClose, closeLabel = 'Cancel' }: {
  ...
  const [kind, setKind] = useState<Exclude<Kind, DeviceProviderKind | 'crewly-gateway'> | null>(null);
